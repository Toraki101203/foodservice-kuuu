  ...
  return (
    <div className="min-h-dvh bg-gradient-to-b from-orange-50 to-white">
      ...
      <section className="px-4 py-12 text-center md:py-20">
        <h1 className="mb-4 text-4xl font-bold leading-tight text-gray-900 text-balance md:text-5xl">
          飲食店の
          <span className="text-orange-500">「今」</span>
          がわかる
        </h1>
        <p className="mx-auto mb-8 max-w-md text-lg text-gray-600 leading-relaxed text-pretty">
          リアルタイムで空席状況をチェック。
          <br />
          予約もその場で完了できます。
        </p>
      ...
      <section className="bg-white px-4 py-12 md:py-20">
        <h2 className="mb-10 text-center text-2xl font-bold text-gray-900 text-balance md:text-3xl">
          Kuuu でできること
        </h2>
        <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-3">
          <div className="text-center">
            <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-green-100 text-3xl">
              <span className="size-8 rounded-full bg-green-500" />
            </div>
          ...
          <div className="text-center">
            <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-orange-100 text-3xl">
              <span className="size-8 rounded-full bg-orange-500" />
            </div>
            <h3 className="mb-2 text-lg font-semibold text-gray-900">
              かんたん予約
            </h3>
      ...
      <section className="px-4 py-12 md:py-20">
        <div className="mx-auto max-w-4xl rounded-2xl bg-orange-500 p-8 text-center text-white md:p-12">
          <h2 className="mb-4 text-2xl font-bold text-balance md:text-3xl">
            飲食店オーナーの皆様へ
          </h2>
          <p className="mb-6 text-orange-100 leading-relaxed text-pretty md:text-lg">
            予約手数料0円で集客力アップ。
            <br />
      ...
      <footer className="border-t border-gray-200 bg-white px-4 py-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-sm text-gray-400">
            &copy; 2026 Kuuu. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
